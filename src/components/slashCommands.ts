...
export const slashCommands: SlashCommand[] = [
  {
    ...
    prompt: '请用文学秘书模式回答：先直接解释这个文学或写作概念，再给出例子、常见误区和可用于写作的迁移方法。',
  ...
  },
  {
    ...
    prompt: '请在需要时联网搜索资料，区分可靠信息、待核实线索、可写材料和引用风险，并给出适合写入文章的素材摘要。',
    icon: Globe2,
    scopes: ['companion', 'flow'],
  },
  {
    ...
    prompt: '续写当前文稿，保持已有语气、节奏和信息密度。需要写入文稿时，请输出“正文:”。',
    icon: FilePenLine,
    scopes: ['companion', 'flow'],
  },
  {
  ...
  },
  {
    ...
    prompt: '请对当前作文进行升格：保留原意，优化立意、结构、细节、论证或说明顺序，并列出修改依据。',
    icon: Wand2,
    scopes: ['companion', 'flow'],
  },
  {
    ...
    prompt: '请为记叙文准备素材：给出可写事件、细节描写、人物动作、环境烘托、转折位置和首尾照应方式。',
    icon: Sparkles,
    scopes: ['companion', 'flow'],
  },
  {
    ...
    prompt: '请为说明文建立结构：明确说明对象、核心特征、说明顺序、说明方法、生活案例和语言准确性注意点。',
    icon: BookOpenText,
    scopes: ['companion', 'flow'],
  },
  {
    ...
    prompt: '请为议论文锻造论证：给出中心命题、递进分论点、事实论据、道理论据、反方观点与回应方式。',
    icon: SearchCheck,
    scopes: ['companion', 'flow'],
  },
  {
    ...
    prompt: '请按评论写作处理：区分事实、判断和价值尺度，给出核心观点、材料分析、反例风险和可写段落。',
    icon: SearchCheck,
    scopes: ['companion', 'flow'],
  },
  {
    ...
    prompt: '请为这个作品执行深度初始化：建立作品圣经、题材类型、目标规模、主角欲望与缺陷、核心冲突、世界观规则、读者承诺，并给出第一卷规划。',
    icon: BookOpenText,
    scopes: ['flow'],
  },
  {
    ...
    prompt: '请按 Papyrus Story System 写下一章：先建立章节合同和写作任务书，再起草、审查、二稿，最后生成可写入文稿的正文。',
    icon: FilePenLine,
    scopes: ['flow'],
  },
  {
    ...
    prompt: '请打开或总结连载控制台：章节提交链、开放伏笔、读者承诺、角色状态、节奏风险和发布准备度。',
    icon: Gauge,
    scopes: ['flow'],
  },
  {
    ...
    prompt: '请诊断当前文稿结构：指出目标、阻力、转折、后果或论证闭环中的问题，并给出可执行改法。',
    icon: ListChecks,
    scopes: ['companion', 'flow'],
  },
  {
    ...
    prompt: '润色这段文字：保留作者原意和声音，让表达更自然、克制、有文学质感，并减少模板感。',
    icon: Wand2,
    scopes: ['companion', 'flow'],
  },
  {
    ...
    prompt: '请做终校清稿：检查错别字、病句、标点、术语一致性、重复表达和可能的误读，并给出清稿版本。',
    icon: SearchCheck,
    scopes: ['companion', 'flow'],
  },
  {
    ...
    prompt: '只给我写作建议，不要写入文稿。请指出最值得修改的问题，并给出下一步做法。',
    icon: MessageSquareText,
    scopes: ['companion'],
  },
  {
