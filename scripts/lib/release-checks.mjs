...
const WORKFLOW_SEMANTIC_MARKERS = {
  ...
  '.github/workflows/desktop-packages.yml': [
    ...
    ['run the hosted-runner bundle smoke', 'node scripts/smoke-tauri-bundle.mjs --bundle-dir'],
    ['upload hosted-runner bundle smoke logs', 'path: ${{ runner.temp }}/papyrus-bundle-smoke'],
    ['install Linux bundle smoke display dependencies', 'xvfb dbus-x11'],
