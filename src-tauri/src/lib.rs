...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            work_assistant::work_assistant_computer_observe,
            work_assistant::work_assistant_computer_preview,
            work_assistant::work_assistant_computer_approve,
            work_assistant::work_assistant_computer_execute,
